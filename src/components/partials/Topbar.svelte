        ...
        >
              ...
              <div class="d-flex">
                ...
                <div class="flex-1">
                  ...
                  <div class="font-size-13 text-muted">
                    <p class="mb-1">If several languages coalesce the grammar</p>
                    <p class="mb-0 font-size-12">
                      <i class="mdi mdi-clock-outline" /> <span>3 hours ago</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="d-flex">
                ...
                <div class="flex-1">
                  ...
                  <div class="font-size-13 text-muted">
                    ...
                    <p class="mb-0 font-size-12">
                      <i class="mdi mdi-clock-outline" /> <span>10 hours ago</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="p-2 border-top d-grid">
            <a class="btn btn-sm btn-link font-size-14 text-center" href="javascript:void(0)">
              <i class="mdi mdi-arrow-right-circle me-1" /> <span>View More..</span>
            </a>
          </div>
        </div>
      </div>
